module special_functions
    !! Collection of special math functions from <a href="https://people.sc.fsu.edu/~jburkardt/f_src/special_functions/special_functions.html">here</a> 
    implicit none
...
contains
    ...
    subroutine chgubi ( a, b, x, hu, id )
      ...
      !    U(a,b,x) with integer ( kind = 4 ) b ( b = ñ1,ñ2,... )
      !
      !  Licensing:
      !
      !    This routine is copyrighted by Shanjie Zhang and Jianming Jin.  However, 
    ...
    subroutine lagzo ( n, x, w )
      ...
      !    interval [0,ì], and the corresponding weighting coefficients for 
