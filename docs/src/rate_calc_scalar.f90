module rate_calc_scalar
    !! Compute the scalar DM absorption rate.
...
contains
    ...
    subroutine calc_rate_scalar(pi_1_1_mat, pi_v2_v2, v_vec, dm_model, expt, widths, &
            target_mat, numerics, abs_rate, verbose)
        !! Compute the scalar DM absorption rate at a given \( \mathbf{v} \).
